...
public partial class NhtLesson09Context : DbContext
{
    public NhtLesson09Context()
    {
    }

    public NhtLesson09Context(DbContextOptions<NhtLesson09Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-BE78S1Q\\TUYENCHUYENVAN1;Database=NhtLesson09;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A699426C56");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2073C1E6337");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B384886E8");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFF9906FA4");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36CA0A9E587");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB5CC09E5D");
